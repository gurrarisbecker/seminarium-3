// Fil: se/kth/view/TeachingAllocationCLI.java
...
public class TeachingAllocationCLI {
    ...
    // Hjälpmetod för att läsa strängar
private String readString(String prompt) {
        System.out.print(prompt);
        return scanner.nextLine().trim(); // .trim() tar bort onödiga mellanslag
    }

    // --- IMPLEMENTATION AV MENYVAL ---
